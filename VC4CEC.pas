...
type
  ...
  CEC_DEVICE_TYPE_T = byte;
  CEC_DISPLAY_CONTROL_T = byte;
  CEC_USER_CONTROL_T = byte;
  CEC_AllDevices_T = byte;
 ...
 *)
  VC_CEC_TOPOLOGY_T = packed record
    active_mask : word;
    num_devices : word;
...
begin
  case op of
    CEC_Opcode_FeatureAbort 	             : Result := 'FeatureAbort';
    CEC_Opcode_ImageViewOn 	               : Result := 'ImageViewOn';
    CEC_Opcode_TunerStepIncrement    	     : Result := 'TunerStepIncrement';
    CEC_Opcode_TunerStepDecrement    	     : Result := 'TunerStepDecrement';
    CEC_Opcode_TunerDeviceStatus 	         : Result := 'TunerDeviceStatus';
    CEC_Opcode_GiveTunerDeviceStatus 	     : Result := 'GiveTunerDeviceStatus';
    CEC_Opcode_RecordOn 	                 : Result := 'RecordOn';
    CEC_Opcode_RecordStatus 	             : Result := 'RecordStatus';
    CEC_Opcode_RecordOff 	                 : Result := 'RecordOff';
    CEC_Opcode_TextViewOn 	               : Result := 'TextViewOn';
    CEC_Opcode_RecordTVScreen              : Result := 'RecordTVScreen';
    CEC_Opcode_GiveDeckStatus        	     : Result := 'GiveDeckStatus';
    CEC_Opcode_DeckStatus 	               : Result := 'DeckStatus';
    CEC_Opcode_SetMenuLanguage             : Result := 'SetMenuLanguage';
    CEC_Opcode_ClearAnalogTimer            : Result := 'ClearAnalogTimer';
    CEC_Opcode_SetAnalogTimer              : Result := 'SetAnalogTimer';
    CEC_Opcode_TimerStatus                 : Result := 'TimerStatus';
    CEC_Opcode_Standby 	                   : Result := 'Standby';
    CEC_Opcode_Play                  	     : Result := 'Play';
    CEC_Opcode_DeckControl 	               : Result := 'DeckControl';
    CEC_Opcode_TimerClearedStatus          : Result := 'TimerClearedStatus';
    CEC_Opcode_UserControlPressed 	       : Result := 'UserControlPressed';
    CEC_Opcode_UserControlReleased 	       : Result := 'UserControlReleased';
    CEC_Opcode_GiveOSDName           	     : Result := 'GiveOSDName';
    CEC_Opcode_SetOSDName 	               : Result := 'SetOSDName';
    CEC_Opcode_SetOSDString 	             : Result := 'SetOSDString';
    CEC_Opcode_SetTimerProgramTitle        : Result := 'SetTimerProgramTitle';
    CEC_Opcode_SystemAudioModeRequest      : Result := 'SystemAudioModeRequest';
    CEC_Opcode_GiveAudioStatus             : Result := 'GiveAudioStatus';
    CEC_Opcode_SetSystemAudioMode          : Result := 'SetSystemAudioMode';
    CEC_Opcode_ReportAudioStatus           : Result := 'ReportAudioStatus';
    CEC_Opcode_GiveSystemAudioModeStatus   : Result := 'GiveSystemAudioModeStatus';
    CEC_Opcode_SystemAudioModeStatus       : Result := 'SystemAudioModeStatus';
    CEC_Opcode_RoutingChange 	             : Result := 'RoutingChange';
    CEC_Opcode_RoutingInformation 	       : Result := 'RoutingInformation';
    CEC_Opcode_ActiveSource 	             : Result := 'ActiveSource';
    CEC_Opcode_GivePhysicalAddress         : Result := 'GivePhysicalAddress';
    CEC_Opcode_ReportPhysicalAddress       : Result := 'ReportPhysicalAddress';
    CEC_Opcode_RequestActiveSource 	       : Result := 'RequestActiveSource';
    CEC_Opcode_SetStreamPath 	             : Result := 'SetStreamPath';
    CEC_Opcode_DeviceVendorID 	           : Result := 'DeviceVendorID ';
    CEC_Opcode_VendorCommand         	     : Result := 'VendorCommand';
    CEC_Opcode_VendorRemoteButtonDown 	   : Result := 'VendorRemoteButtonDown';
    CEC_Opcode_VendorRemoteButtonUp    	   : Result := 'VendorRemoteButtonUp';
    CEC_Opcode_GiveDeviceVendorID    	     : Result := 'GiveDeviceVendorID';
    CEC_Opcode_MenuRequest 	               : Result := 'MenuRequest';
    CEC_Opcode_MenuStatus 	               : Result := 'MenuStatus';
    CEC_Opcode_GiveDevicePowerStatus 	     : Result := 'GiveDevicePowerStatus';
    CEC_Opcode_ReportPowerStatus 	         : Result := 'ReportPowerStatus';
    CEC_Opcode_GetMenuLanguage             : Result := 'GetMenuLanguage';
    CEC_Opcode_SelectAnalogService         : Result := 'SelectAnalogService';
    CEC_Opcode_SelectDigitalService   	   : Result := 'SelectDigitalService';
    CEC_Opcode_SetDigitalTimer             : Result := 'SetDigitalTimer';
    CEC_Opcode_ClearDigitalTimer           : Result := 'ClearDigitalTimer';
    CEC_Opcode_SetAudioRate                : Result := 'SetAudioRate';
    CEC_Opcode_InactiveSource        	     : Result := 'InactiveSource';
    CEC_Opcode_CECVersion                  : Result := 'CECVersion';
    CEC_Opcode_GetCECVersion               : Result := 'GetCECVersion';
    CEC_Opcode_VendorCommandWithID         : Result := 'VendorCommandWithID';
    CEC_Opcode_ClearExternalTimer          : Result := 'ClearExternalTimer';
    CEC_Opcode_SetExternalTimer            : Result := 'SetExternalTimer';
    CEC_Opcode_ReportShortAudioDescriptor  : Result := 'ReportShortAudioDescriptor';
    CEC_Opcode_RequestShortAudioDescriptor : Result := 'RequestShortAudioDescriptor';
    CEC_Opcode_InitARC                     : Result := 'InitARC';
    CEC_Opcode_ReportARCInited             : Result := 'ReportARCInited';
    CEC_Opcode_ReportARCTerminated         : Result := 'ReportARCTerminated';
    CEC_Opcode_RequestARCInit              : Result := 'RequestARCInit';
    CEC_Opcode_RequestARCTermination       : Result := 'RequestARCTermination';
    CEC_Opcode_TerminateARC                : Result := 'TerminateARC';
